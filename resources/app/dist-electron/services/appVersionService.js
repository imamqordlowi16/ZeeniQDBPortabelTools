...
class AppVersionService {
    ...
    static getCurrentVersion() {
        ...
        try {
            if (fs_1.default.existsSync(versionFile)) {
                const val = fs_1.default.readFileSync(versionFile, 'utf8').trim();
            ...
            console.error('Failed to read version.txt:', e);
        }
    ...
    static setVersion(version) {
        ...
        const versionFile = this.getVersionFilePath();
        try {
            fs_1.default.writeFileSync(versionFile, clean, 'utf8');
        }
        catch (e) {
            console.error('Failed to write version.txt:', e);
            throw e;
        }
        // Also sync to root package.json if in development
        try {
